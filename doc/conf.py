...
sys.path.insert(0, os.path.abspath(os.path.join('..', 'desipipe')))
...
git_repo = 'https://github.com/cosmodesi/desipipe.git'
git_root = 'https://github.com/cosmodesi/desipipe/blob/main/'
